...
import EmptyMemoriesComponent from "@/components/EmptyMemories";
...
export default async function Home() {
  ...
  if (!isAuthenticated) return <EmptyMemoriesComponent />;
  ...
  if (memories.length === 0) return <EmptyMemoriesComponent />;
